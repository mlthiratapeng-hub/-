...
class PermissionView(discord.ui.View):
    ...
    @discord.ui.button(label="✅ อนุญาต Anti-Spam", style=discord.ButtonStyle.success)
    ...
    @discord.ui.button(label="🗑 ลบออกจากระบบ", style=discord.ButtonStyle.danger)
...
class AntiMainView(discord.ui.View):
    ...
    @discord.ui.button(label="🔄 เปิด/ปิด ระบบ", style=discord.ButtonStyle.primary)
    ...
    @discord.ui.button(label="⚙️ จัดการสิทธิ์", style=discord.ButtonStyle.secondary)
